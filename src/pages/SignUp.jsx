      ...
      <div className="auth-right">
        ...
        >
          ...
          <div className="oauth-container" style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginBottom: '2rem', width: '100%' }}>
            <button className="oauth-btn" type="button" onClick={() => handleOAuth("Google")}>
            ...
            <button className="oauth-btn" type="button" onClick={() => handleOAuth("GitHub")}>
            ...
            <button className="oauth-btn" type="button" onClick={() => handleOAuth("Magic Link")}>
